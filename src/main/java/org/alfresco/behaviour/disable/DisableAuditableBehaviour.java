 ...
 * 
 * "triggeringAspectQName" can be specified at alfresco-global.properties, by
 * default:
 * 
 * triggering.aspect.qname={http://www.alfresco.org/model/content/1.0}templatable
 * 
 * Usage: By default, when a change is performed on a node having AUDITABLE
 * ASPECT, Alfresco changes "cm:modified" and "cm:modifier" properties. When
 * using this module, these properties remain unchanged after adding the Aspect
 * specified in alfresco-global.properties
 * 
 * @author aborroy
 *
 */
public class DisableAuditableBehaviour implements NodeServicePolicies.BeforeAddAspectPolicy
{
    ...
    /**
     * Listen to "afterCommit" event to restore the behaviour for every related
     * node.
     */
    private TransactionListener transactionListener;

    /**
     * Binds "beforeAddAspect" behaviour associated to "triggeringAspectQName"
     * aspect. Creates the transactionListener instance.
     */
    public void init()
    {

        this.policyComponent.bindClassBehaviour(NodeServicePolicies.BeforeAddAspectPolicy.QNAME,
     ...
     * (non-Javadoc)
     * 
     * @see org.alfresco.repo.node.NodeServicePolicies.BeforeAddAspectPolicy#
     * beforeAddAspect(org.alfresco.service.cmr.repository.NodeRef,
    ...
    /**
     * Listen to "afterCommit" event to restore AUDITABLE ASPECT Behavior for every
     * related node in the transaction
     * 
     * @author aborroy
     *
     */
    private class RestoreAuditableBehaviourTransactionListener extends TransactionListenerAdapter
